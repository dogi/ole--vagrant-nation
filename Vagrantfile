...
Vagrant.configure(2) do |config|
  ...
  config.vm.hostname = "nation"

  config.vm.define "nation" do |community|
  end
  ...
  config.vm.network "forwarded_port", guest: 5984, host: 5982, auto_correct: true
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo '"127.0.0.1": "http://127.0.0.1:5982/apps/_design/bell/MyApp/index.html",' >> server.js
    echo '"localhost": "http://localhost:5982/apps/_design/bell/MyApp/index.html"' >> server.js
    echo '}' >> server.js
